...
const RING_PRESETS: RingConfig[] = [
  ...
  { scale: 0.82, rotateX: 28, rotateY: 52, duration: 8, direction: -1, opacity: 0.6 },
  { scale: 1.0, rotateX: 55, rotateY: 28, duration: 11, direction: 1, opacity: 0.38 },
]
...
export function RingOrbit3D({
  ...
  return (
    <div
      className={cn('justify-content-center relative flex items-center', className)}
