...
function ShowcaseSection({
  ...
  return (
    <LayerReveal>
      <section id={id} className="border-t py-12" style={{ borderColor: 'var(--card-border)' }}>
        <div className="mb-8">
          <h2 className="mb-1.5 text-2xl font-bold" style={{ color: 'hsl(var(--text-heading))' }}>
            {title}
          </h2>
          {description && (
...
const TABLE_COLS = [
  ...
  { key: 'role', header: 'Role' },
  {
    key: 'status',
    header: 'Status',
    render: (v: unknown) => <TableStatusCell status={String(v)} />,
  },
      ...
      <Dropdown
        ...
        items={[
          ...
          },
          {
            ...
            onClick: () => toast.success('ID copied!'),
          },
          'divider',
          {
            key: 'delete',
      ...
      <div className="mx-auto max-w-5xl px-6 pb-40">
        ...
        <div className="pb-4 pt-20">
          <LayerReveal>
            <Link
              href="/"
              className="mb-8 inline-flex items-center gap-1.5 font-mono text-xs transition-opacity hover:opacity-70"
          ...
          <LayerReveal delay={40}>
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                <h1 className="gradient-text mb-2 text-4xl font-black">Design System</h1>
                <p className="max-w-lg text-sm" style={{ color: 'hsl(var(--text-body))' }}>
                  28 components that morph across 9 design systems. Switch themes at the bottom —
                  every component adapts its shape, shadow, border, and feel.
                </p>
              </div>
              <div className="flex flex-wrap items-center gap-2">
                {(['primary', 'success', 'warning', 'error', 'info'] as const).map((v) => (
                  <LibBadge key={v} variant={v} dot>
        ...
        <ShowcaseSection
          id="avatars"
          title="Avatars"
          description="User avatars with image, initials fallback, online indicator, and 5 sizes."
        >
          ...
          <Sub title="Avatar group">
            <div className="flex items-center">
              {['Manish Soni', 'Anika Patel', 'Ravi Kumar', 'Priya Sharma', 'Dev Ops'].map(
                (n, i) => (
              ...
              <div style={{ marginLeft: '-10px', zIndex: 1 }}>
                <div
                  className="ui-avatar ui-avatar-md"
                  style={{
        ...
        <ShowcaseSection
          id="cards"
          title="Cards"
          description="Content cards with header, body, footer sub-components. Shape and shadow adapt per theme."
        >
          <Sub title="Variants">
              ...
              <Card hover>
                <CardHeader>
                  <div className="flex w-full items-start justify-between gap-2">
                    ...
                    <LibBadge variant="success" size="sm" dot>
                      Active
                    </LibBadge>
                  </div>
                </CardHeader>
                <CardBody>
                  <p className="text-sm" style={{ color: 'hsl(var(--text-body))' }}>
                    Cards morph completely between themes — rounded glass in Aurora, neumorphic clay
                    in Clay, brutal-bordered in Neobrutalism.
                  </p>
                </CardBody>
                <CardFooter>
                  <LibButton variant="primary" size="sm">
                    View details
                  </LibButton>
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="text-xs" style={{ color: 'hsl(var(--text-body))' }}>
                    Building fintech infrastructure at Mercato. Previously IIT Roorkee. Passionate
                    about design systems and developer experience.
                  </p>
                  <div className="mt-3 flex gap-2">
                    <LibBadge variant="primary" size="sm">
                      Next.js
                    </LibBadge>
                    <LibBadge variant="info" size="sm">
                      Go
                    </LibBadge>
                    <LibBadge variant="default" size="sm">
                      AWS
                    </LibBadge>
                  </div>
                </CardBody>
        ...
        <ShowcaseSection
          id="stats"
          title="Stat Cards"
          description="KPI and metric display cards with delta indicators and trend icons."
        >
          <Sub title="Grid">
        ...
        <ShowcaseSection
          id="tabs"
          title="Tabs"
          description="Three variants with animated Framer Motion indicators. The underline type slides, the pill type morphs."
        >
        ...
        <ShowcaseSection
          id="accordion"
          title="Accordion"
          description="Smooth height animation via Framer Motion. Supports single or multi-open mode."
        >
            ...
            <div className="max-w-2xl">
              <Accordion
                items={[
                  {
                    key: 'q1',
                    title: 'How does the theme switcher work?',
                    icon: <LayersIcon className="h-4 w-4" />,
                    subtitle: 'Design system internals',
                    children: (
                      <p>
                        The{' '}
                        <code style={{ color: 'hsl(var(--primary))' }}>
                          {'html[data-style="X"]'}
                        </code>{' '}
                        attribute triggers per-theme CSS overrides in themes.css. Every component
                        uses semantic CSS variables — switching the attribute re-skins everything
                  ...
                  {
                    key: 'q2',
                    title: 'What makes each theme structurally different?',
                    icon: <CodeIcon className="h-4 w-4" />,
                    children: (
                      <p>
                        Beyond colors, each theme changes <strong>border-radius</strong> (0px in
                        Neobrutalism → 14px in Clay), <strong>shadows</strong> (hard drop-shadows vs
                        neumorphic insets vs neon glows), <strong>border-width</strong>, font-family
                        (monospace in Carbon), and transition speed.
                      </p>
                    ),
                  },
                  {
                    key: 'q3',
                    title: 'Which frameworks are used?',
                    icon: <ZapIcon className="h-4 w-4" />,
                    defaultOpen: true,
                    children: (
                      <div className="flex flex-wrap gap-2">
                        <LibBadge variant="primary">Next.js 15</LibBadge>
                        <LibBadge variant="info">React 19</LibBadge>
                        <LibBadge variant="default">Framer Motion</LibBadge>
                        <LibBadge variant="default">TypeScript</LibBadge>
                        <LibBadge variant="default">Tailwind CSS</LibBadge>
                        <LibBadge variant="default">Zustand</LibBadge>
                      </div>
                    ),
                  },
                ]}
        ...
        <ShowcaseSection
          id="progress"
          title="Progress Bars"
          description="Animated fill with Framer Motion. Variants, sizes, and optional glow animation."
        >
        ...
        <ShowcaseSection
          id="toggles"
          title="Toggles"
          description="Animated thumb with Framer Motion layout animation. Three sizes with label and description slots."
        >
        ...
        <ShowcaseSection
          id="alerts"
          title="Alerts"
          description="Inline notification banners with left-accent stripe, dismissable, and AnimatePresence exit animation."
        >
          <Sub title="All variants">
            <div className="max-w-2xl space-y-3">
              ...
              >
                Your changes went live to production 2 minutes ago. No errors detected.
              </Alert>
              <Alert variant="error" title="Build failed" onDismiss={() => {}}>
                TypeScript error in <code>contact-section.tsx</code> line 42 — parameter
                &apos;e&apos; implicitly has type &apos;any&apos;.
              </Alert>
              <Alert variant="warning" title="API rate limit approaching">
                You&apos;ve used 87% of your monthly quota. Upgrade to avoid disruption.
              </Alert>
              <Alert variant="info">
                Scheduled maintenance on Sunday 02:00–04:00 UTC. Read-only mode will be active
                during the window.
              </Alert>
            </div>
          </Sub>
        ...
        <ShowcaseSection
          id="tooltips"
          title="Tooltips"
          description="Portal-rendered hover tooltips with 4 placements and configurable delay. Escape stacking context issues."
        >
          <Sub title="Placements">
            <div className="flex flex-wrap items-center gap-4 py-4">
              <Tooltip content="Rendered above via portal" placement="top" delay={0}>
                <LibButton variant="secondary" size="sm">
                  Top
                </LibButton>
              </Tooltip>
              ...
              <Tooltip
                content="Download the complete design system source code as a ZIP archive"
                placement="top"
              >
                <LibButton
                  variant="outline"
        ...
        <ShowcaseSection
          ...
          description="Shimmer-animated loading placeholders. Base Skeleton + SkeletonText + SkeletonCard presets."
        >
          <Sub title="Shapes">
            <div className="flex flex-wrap items-end gap-4">
        ...
        <ShowcaseSection
          id="breadcrumb"
          title="Breadcrumbs"
          description="Navigation breadcrumb trail with configurable separator and link support."
        >
          <Sub title="Examples">
            <div className="space-y-4">
              <Breadcrumb
                items={[
                  { label: 'Home', href: '/', icon: <HomeIcon className="h-3 w-3" /> },
              ...
              <Breadcrumb
                items={[
                  { label: 'Dashboard', href: '#', icon: <LayersIcon className="h-3 w-3" /> },
                  { label: 'Design', href: '#', icon: <FolderIcon className="h-3 w-3" /> },
                  { label: 'Component Library', icon: <FileIcon className="h-3 w-3" /> },
                ]}
        ...
        <ShowcaseSection
          id="pagination"
          title="Pagination"
          description="Page navigation with ellipsis window, edge buttons, and active page highlight."
        >
        ...
        <ShowcaseSection
          id="code"
          title="Code Block"
          description="Syntax-highlighted code with copy-to-clipboard, filename, language badge. Carbon theme makes this feel very terminal."
        >
          <Sub title="Example">
            <CodeBlock
              code={SAMPLE_CODE}
        ...
        <ShowcaseSection
          id="timeline"
          title="Timeline"
          description="Vertical event timeline with variant dot colors and connecting lines."
        >
            ...
            <div className="max-w-lg">
              <Timeline
                events={[
                  {
                    id: '1',
                    title: 'v2.0 shipped to production',
                    description:
                  ...
                  {
                    id: '2',
                    title: 'Optimistic UI added',
                    description: 'React 19 useOptimistic for skill endorsements and contact form.',
                    date: 'Apr 2026',
                    variant: 'info',
                  },
                  {
                    id: '3',
                    title: 'Multi-theme system built',
                    description:
        ...
        <ShowcaseSection
          id="buttons"
          title="Buttons"
          description="Five semantic variants × four sizes. Loading state and Framer Motion press animation."
        >
          <Sub title="Variants">
            <div className="flex flex-wrap gap-3">
              <LibButton variant="primary" leftIcon={<ZapIcon className="h-4 w-4" />}>
                Primary
              </LibButton>
              <LibButton variant="secondary">Secondary</LibButton>
              <LibButton variant="outline" leftIcon={<StarIcon className="h-4 w-4" />}>
                Outline
              </LibButton>
          ...
          <Sub title="Sizes">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <LibButton variant="primary" size="md">
                Medium
              </LibButton>
              <LibButton variant="primary" size="lg">
                Large
              </LibButton>
              <LibButton variant="primary" size="xl">
                X-Large
              </LibButton>
              <LibButton variant="secondary" size="icon">
          ...
          <Sub title="States + live toasts">
            <div className="flex flex-wrap gap-3">
              <LibButton variant="primary" loading>
                Saving…
              </LibButton>
              <LibButton variant="secondary" disabled>
                Disabled
              </LibButton>
              <LibButton
                variant="outline"
                leftIcon={<DownloadIcon className="h-4 w-4" />}
                rightIcon={<ExternalLinkIcon className="h-3.5 w-3.5 opacity-60" />}
              >
                With Icons
              </LibButton>
              <LibButton
                variant="primary"
                onClick={() => toast.success('Primary clicked!', 'Action was successful.')}
              >
                Success Toast
              </LibButton>
              <LibButton
                variant="danger"
                onClick={() => toast.error('Action failed', 'Something went wrong.')}
              >
                Error Toast
              </LibButton>
            </div>
        ...
        <ShowcaseSection
          id="inputs"
          title="Inputs & Forms"
          description="Full-featured form controls with labels, hints, validation states, and focus animations."
        >
          <Sub title="Text inputs">
            <div className="grid max-w-2xl gap-5 sm:grid-cols-2">
              <Input
                label="Full Name"
                placeholder="Manish Soni"
                value={inputVal}
                onChange={(e) => setInputVal(e.target.value)}
                hint="Enter your legal name"
                leftIcon={<BriefcaseIcon className="h-3.5 w-3.5" />}
              />
              <Input
                label="Email"
                placeholder="you@example.com"
                type="email"
                leftIcon={<MailIcon className="h-3.5 w-3.5" />}
              />
              <Input
                label="With Error"
                placeholder="bad@input.com"
                error="That email is already taken."
                leftIcon={<MailIcon className="h-3.5 w-3.5" />}
                defaultValue="duplicate@test.com"
              />
              <Input
                label="Disabled"
        ...
        <ShowcaseSection
          id="badges"
          title="Badges"
          description="Semantic status indicators with optional dot. Auto-adapt across all 9 themes."
        >
          <Sub title="Variants">
            <div className="flex flex-wrap gap-2">
              ...
              <LibBadge variant="warning" dot>
                Pending
              </LibBadge>
              <LibBadge variant="error" dot>
                Error
              </LibBadge>
        ...
        <ShowcaseSection
          id="toasts"
          title="Toasts"
          description="Portal-rendered animated notifications with auto-dismiss."
        >
          <Sub title="Preview">
          ...
          <Sub title="Live">
            <div className="flex flex-wrap gap-3">
              <LibButton
                variant="secondary"
                size="sm"
                onClick={() => toast.success('Profile saved!', 'Your changes applied.')}
              >
                ✓ Success
              </LibButton>
              <LibButton
                variant="secondary"
                size="sm"
                onClick={() => toast.error('Upload failed', 'File exceeds 10 MB.')}
              >
                ✕ Error
              </LibButton>
              <LibButton
                variant="secondary"
                size="sm"
                onClick={() => toast.warning('Rate limit', '90% of monthly quota used.')}
              >
                ⚠ Warning
              </LibButton>
              <LibButton
                variant="secondary"
                size="sm"
                onClick={() => toast.info('Tip', 'Press Ctrl+K for command palette.')}
              >
                ℹ Info
              </LibButton>
            </div>
        ...
        <ShowcaseSection
          id="dialogs"
          title="Dialogs"
          description="Accessible portal modals. Escape close, backdrop dismiss, scroll lock, AnimatePresence."
        >
          <Sub title="Examples">
            <div className="flex flex-wrap gap-3">
          ...
          <Dialog
            ...
            description="Dialogs are portaled to document.body and adapt per theme."
          >
            <div className="space-y-3 text-sm" style={{ color: 'hsl(var(--text-body))' }}>
              <p>
                Open in Neobrutalism for thick borders, Clay for neumorphic depth, or Neon Noir for
                a pink glow. The structure is identical — only theme CSS changes.
              </p>
            </div>
            <DialogFooter>
              <LibButton variant="ghost" size="sm" onClick={() => setDialogOpen(false)}>
                Cancel
              </LibButton>
              <LibButton
                variant="primary"
          ...
          >
            <DialogFooter>
              <LibButton variant="ghost" size="sm" onClick={() => setConfirmOpen(false)}>
                Cancel
              </LibButton>
              <LibButton
                variant="danger"
        ...
        <ShowcaseSection
          id="dropdowns"
          title="Dropdowns"
          description="Portal-rendered menus — escape stacking context from Framer Motion transforms."
        >
          <Sub title="Examples">
            <div className="flex flex-wrap items-start gap-4">
              <Dropdown
                trigger={
                  <LibButton
                    variant="secondary"
                    rightIcon={<ExternalLinkIcon className="h-3.5 w-3.5 opacity-50" />}
                  >
                    Actions
                  </LibButton>
                }
              ...
              <Dropdown
                align="right"
                trigger={
                  <LibButton variant="outline" size="icon">
                    <MoreHorizontalIcon className="h-4 w-4" />
                  </LibButton>
                }
                items={[
        ...
        <ShowcaseSection
          id="tables"
          title="Tables"
          description="Responsive data tables with status cells and per-row action dropdowns."
        >
        ...
        <ShowcaseSection
          id="themes"
          title="Theme Palette"
          description="All 9 design systems. Each changes shape, shadow, border style, font feel, and color — not just hues."
        >
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
            {[
              {
                name: 'Veil',
                desc: 'Default · midnight navy + teal/gold · soft glow',
                a: '#00FFDA',
                b: '#F5A623',
                bg: '#050d1a',
                radius: '10px',
              ...
              {
                name: 'Aurora',
                desc: 'Rounded · light glass + indigo/fuchsia · backdrop blur',
                a: '#6D5BFF',
                b: '#C026D3',
                bg: '#f5f3ff',
                radius: '16px',
              ...
              {
                name: 'Carbon',
                desc: 'Sharp · charcoal + terminal cyan · monospace font',
                a: '#00D2E6',
                b: '#00f0ff',
                bg: '#0d111a',
                radius: '3px',
              ...
              {
                name: 'Clay',
                desc: 'Soft · warm cream + terracotta · neumorphic shadows',
                a: '#b44b23',
                b: '#c66a1e',
                bg: '#f5eee6',
                radius: '14px',
              ...
              {
                name: 'Pulse',
                desc: 'Bold · white + coral · thick 2px borders · flat',
                a: '#f0321e',
                b: '#f58214',
                bg: '#fafafa',
                radius: '6px',
              ...
              {
                name: 'Obsidian',
                desc: 'Dark · pure black + neon lime · sharp edges',
                a: '#82e600',
                b: '#ffe600',
                bg: '#080808',
                radius: '4px',
              ...
              {
                name: 'Neobrutalism',
                desc: 'Zero radius · thick black borders · hard drop shadows',
                a: '#ffeb00',
                b: '#ff1580',
                bg: '#fffde6',
                radius: '0px',
              ...
              {
                name: 'Neon Noir',
                desc: 'Thin neon · near-black + hot pink · pink glow borders',
                a: '#ff1ab3',
                b: '#8000ff',
                bg: '#050505',
                radius: '5px',
              ...
              {
                name: 'Synthwave',
                desc: 'Retro · deep purple + pink/cyan · gradient fills',
                a: '#ff1ab3',
                b: '#00e5ff',
                bg: '#140d22',
                radius: '8px',
              ...
              <motion.div
                key={theme.name}
                className="veil-card cursor-default rounded-xl p-4"
                whileHover={{ scale: 1.02, y: -2 }}
                transition={{ type: 'spring', stiffness: 380, damping: 24 }}
              >
                <div className="mb-2 flex items-center gap-2.5">
                  <div
                    className="justify-content-center flex h-6 w-6 items-center rounded-md border border-white/10"
                    style={{ background: theme.bg }}
                  >
                    <div
                      className="mx-auto mt-1.5 h-2.5 w-2.5 rounded-full"
                ...
                <div className="flex gap-1">
                  ...
                  <div
                    className="h-1.5 flex-1 rounded-full border border-white/10"
                    style={{ background: theme.bg }}
                  />
                </div>
                <div className="mt-2 flex items-center gap-1.5">
                  <span
                    ...
                    style={{ background: 'rgba(255,255,255,0.06)', color: 'hsl(var(--text-dim))' }}
                  >
                    r={theme.radius}
                  </span>
                  <span
        ...
        <ShowcaseSection
          id="3d"
          title="3D & Graphics"
          description="Seven GPU-accelerated components — CSS perspective, Framer Motion spring physics, and canvas-drawn particle systems."
        >
          {/* Tilt Cards */}
          <Sub title="Tilt Card 3D — mouse-tracked perspective">
            <div className="grid gap-5 sm:grid-cols-3">
              <TiltCard3D className="veil-card rounded-xl p-5">
                <div className="mb-3 flex items-center gap-3">
                  <div
                    className="justify-content-center flex h-10 w-10 items-center rounded-xl"
                    style={{ background: 'var(--impact-bg)' }}
                  >
                    <SparklesIcon
                      className="mx-auto mt-2.5 h-5 w-5"
                ...
                <p className="text-xs leading-relaxed" style={{ color: 'hsl(var(--text-body))' }}>
                  Hover me — the card tilts toward your cursor with spring physics and a live glare
                  sheen.
                </p>
                <div className="mt-3 flex gap-2">
                  <LibBadge variant="primary" size="sm">
          ...
          <Sub title="Flip Card 3D — hover or click to reveal back">
            <div className="grid gap-5 sm:grid-cols-3">
              <FlipCard3D
                height={200}
                front={
                  <div className="veil-card flex h-full w-full flex-col items-center justify-center gap-2 rounded-xl p-4">
                    <SparklesIcon className="h-8 w-8" style={{ color: 'hsl(var(--primary))' }} />
                    <div
                      className="text-sm font-semibold"
                      style={{ color: 'hsl(var(--text-heading))' }}
                    >
                ...
                back={
                  <div
                    className="flex h-full w-full flex-col items-center justify-center gap-2 rounded-xl p-4"
              ...
              <FlipCard3D
                ...
                front={
                  <div className="veil-card flex h-full w-full flex-col items-center justify-center gap-2 rounded-xl p-4">
                    <CpuIcon className="h-8 w-8" style={{ color: 'hsl(var(--accent))' }} />
                    <div
                      className="text-sm font-semibold"
                      style={{ color: 'hsl(var(--text-heading))' }}
                    >
              ...
              <FlipCard3D
                ...
                front={
                  <div className="veil-card flex h-full w-full flex-col items-center justify-center gap-2 rounded-xl p-4">
                    <GlobeIcon className="h-8 w-8" style={{ color: 'hsl(var(--primary))' }} />
                    <div
                      className="text-sm font-semibold"
                      style={{ color: 'hsl(var(--text-heading))' }}
                    >
              ...
              <Cube3D
                ...
                faces={[
                  <SparklesIcon
                    ...
                    style={{ color: 'hsl(var(--primary))' }}
                  />,
                  <CpuIcon key="r" className="h-8 w-8" style={{ color: 'hsl(var(--accent))' }} />,
                  <GlobeIcon
                    key="b"
                    className="h-8 w-8"
                    style={{ color: 'hsl(var(--primary))' }}
                  />,
                  <CodeIcon key="l" className="h-8 w-8" style={{ color: 'hsl(var(--accent))' }} />,
                  <ZapIcon key="t" className="h-8 w-8" style={{ color: 'hsl(var(--primary))' }} />,
                  <LayersIcon
                    key="d"
                    className="h-8 w-8"
          ...
          <Sub title="Particle Field — 3D-projected canvas with mouse interaction">
            <div
              ...
              style={{ height: 280, borderColor: 'var(--card-border)' }}
            >
              <ParticleField count={100} speed={1} interactive />
              <div
                className="absolute bottom-3 left-4 font-mono text-xs"
                style={{ color: 'hsl(var(--text-dim))' }}
              >
          ...
          <Sub title="Perspective Grid — animated vanishing-point grid, theme-color lines">
            <div
              className="relative overflow-hidden rounded-xl border"
              style={{ height: 260, borderColor: 'var(--card-border)' }}
            >
        ...
        >
          ...
          <Sub title="Warp Tunnel 3D — elliptical rings flying toward the viewer">
            <div className="flex flex-wrap gap-6">
              <div
                className="relative overflow-hidden rounded-xl border"
                style={{ width: 280, height: 220, borderColor: 'var(--card-border)' }}
              >
              ...
              >
                ...
                <div
                  className="absolute bottom-2 left-3 font-mono text-xs"
                  style={{ color: 'hsl(var(--text-dim))' }}
                >
                  speed=2.5 24 rings
                </div>
                  ...
                  <CardBody>
                    <div className="mb-3 flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs" style={{ color: 'hsl(var(--text-dim))' }}>
                          System v2.4.1
                        </div>
                      </div>
                    </div>
                ...
                <div key={mode} className="flex flex-col items-center gap-3">
                  <StackedCards3D
                    ...
                    cards={[
                      <div
                        key="a"
                        className="flex h-full w-full items-center justify-center rounded-[var(--ui-radius,8px)]"
                        style={{
                          background: 'hsl(var(--surface-2))',
                      ...
                      <div
                        ...
                        className="flex h-full w-full items-center justify-center rounded-[var(--ui-radius,8px)]"
                        style={{
                          background: 'hsl(var(--surface-2) / 0.70)',
                          border: '1px solid var(--card-border)',
                        }}
                      >
                        <span
          ...
          <Sub title="Gravity Orbit 3D — n-body physics with trailing trails">
            <div className="flex flex-wrap gap-6">
              <div
                className="relative overflow-hidden rounded-xl border"
                style={{ width: 300, height: 300, borderColor: 'var(--card-border)' }}
              >
          ...
          <Sub title="Neural Net 3D — rotating 3D graph with signal propagation">
            <div
              className="relative overflow-hidden rounded-xl border"
              style={{ height: 340, borderColor: 'var(--card-border)' }}
            >
